package com.example.i.AndroidDemos.view.widget.customizedview.ViewPagerWith3d;
...
public class PagerAdapterWith3D extends PagerAdapter {
    private int[] mBitmapIds;
    private Context mContext;
    private LruCache<Integer, Bitmap> mCache;

    public PagerAdapterWith3D(int[] data, Context context) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_3dviewpager, container, false);
        ImageView imageView = (ImageView) view.findViewById(R.id.imageView_3d);
    ...
    private class LoadBitmapTask extends AsyncTask<Integer, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Integer... params) {
            ...
            options.inJustDecodeBounds = true;     //3dpager1、inJustDecodeBounds置为true，此时只加载图片的宽高信息

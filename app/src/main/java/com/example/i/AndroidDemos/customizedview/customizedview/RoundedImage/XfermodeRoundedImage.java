package com.example.i.AndroidDemos.customizedview.customizedview.RoundedImage;
...
public class XfermodeRoundedImage extends android.support.v7.widget.AppCompatImageView {
    ...
    private static final float SHADOW_RADIUS = 25f;
    private static final int SHADOW_ELEVATION = 25;
    ...
    public XfermodeRoundedImage(Context context) {
        this(context, null);
    }

    public XfermodeRoundedImage(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XfermodeRoundedImage(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        if (elevationSupported()) {
            ...
            OvalShape oval = new XfermodeRoundedImage.OvalShadow(mShadowRadius);
        ...
        mRotateAnimator.setDuration(7200 * 5);
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int viewWidth = XfermodeRoundedImage.this.getWidth();
            final int viewHeight = XfermodeRoundedImage.this.getHeight();

...
public class CicleRotateAlbumView extends ImageView {
    ...
    public CicleRotateAlbumView(Context context) {
        this(context, null);
    }

    public CicleRotateAlbumView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CicleRotateAlbumView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public CicleRotateAlbumView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int viewWidth = CicleRotateAlbumView.this.getWidth();
            final int viewHeight = CicleRotateAlbumView.this.getHeight();
